...
use App\Http\Controllers\Api\PartTemplateController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/cars/catalog-preview', [CarController::class, 'catalogPreview']);
    ...
    Route::apiResource('part-templates', PartTemplateController::class)->except(['show']);
});
